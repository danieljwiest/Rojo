...
const initGameState = (
  ...
  //function was refactored to pass in TILEBAG since as generating it here caused issues with state changes during re-renders.
  ...
  for (let i = 1; i <= playerCount; i++) {
    ...
    for (let j = 0; j < TILE_COLORS.length; j++) {
